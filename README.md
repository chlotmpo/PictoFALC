...
* flask
* thefuzz
* TreeTagger (to help you can head to this tutorial : [**Tutorial TreeTagger**](https://github.com/chlotmpo/PictoFALC/blob/main/Tuto%26Test_Librairies/TreeTagger_Tutoriel.pdf))
