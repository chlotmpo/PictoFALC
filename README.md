...
* flask
* thefuzz
* TreeTagger (to help you can head to this tutorial : [**Tutorial TreeTagger**](https://github.com/chlotmpo/Auto_FALC/blob/main/Tuto&Test_Libraries/TreeTagger_Tutorial.pdf)
